...
export const USER_PASS_FIVE = [
  ...
  { slot: 3, label: "民俗博物館", csvName: "Museum of Folk Culture", day: 6, time: "14:20" },
...
export const FOLK_PERFORMANCE = {
  ...
  scheduled: [
    { day: 7, time: "16:15", note: "美山返回後 · Thanh Ha 之後" },
    { day: 9, time: "10:15", note: "返程日上午 · Klook 接送前" },
  ],
  note: "免費民俗表演，與套票分開。",
};
...
export const PASS_FAQ = [
  ...
  {
    q: "民俗博物館與歷史博物館差別？",
    a: "民俗館重生活文化；歷史館（Hoi An Museum）重城市沿革。兩館都已排進 Day 6。",
  },
  {
    q: "17:30 來得及嗎？",
    a: "Day 6 已排 13:00–16:30 逛完 5 點，16:45 前離開古城區。",
  },
];
